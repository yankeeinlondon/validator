...
import { FailedValidation, UnexpectedError } from "~/errors";
import type { Result } from "~/types/general";
import type { YamlValidationOptions, YamlValidation } from "~/types/yaml";
...
async function loadSchema(schemaRef: string): Promise<Schema | null> {
    try {
        ...
        // Could not load or parse schema
        return null;
    }
}
